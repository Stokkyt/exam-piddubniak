Чудово! Зараз створю типовий **звіт у форматі `README.md`**, який можна використати як документацію до екзаменаційної роботи — із чітко позначеними місцями для **вставки скріншотів**.
